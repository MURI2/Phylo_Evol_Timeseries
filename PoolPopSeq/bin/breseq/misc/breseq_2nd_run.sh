...
mkdir -p /N/dc2/projects/muri2/Task2/PoolPopSeq/bin/breseq/breseq_2nd_run
mkdir -p "/N/dc2/projects/muri2/Task2/PoolPopSeq/bin/breseq/breseq_2nd_run/${DAY}"
mkdir -p /N/dc2/projects/muri2/Task2/PoolPopSeq/data/breseq_2nd_run
mkdir -p "/N/dc2/projects/muri2/Task2/PoolPopSeq/data/breseq_2nd_run/${DAY}"
mkdir -p /N/dc2/projects/muri2/Task2/PoolPopSeq/data/breseq_1st_run_jc_output
...
do
  ...
  pop_gd="/N/dc2/projects/muri2/Task2/PoolPopSeq/data/breseq_1st_run_jc_output/merged/${pop}.gd"
  bash_out="/N/dc2/projects/muri2/Task2/PoolPopSeq/bin/breseq/breseq_2nd_run/${DAY}/${line}_breseq.sh"
  if [ -f $bash_out ]; then
    rm $bash_out
  fi
  ...
  OUT_gbk="/N/dc2/projects/muri2/Task2/PoolPopSeq/data/breseq_2nd_run/${DAY}/${line}"
  mkdir -p $OUT_gbk
  ...
  echo "breseq -j 8 -p --user-evidence-gd ${pop_gd} -o ${OUT_gbk} -r ${REF_gbk} ${reads}" >> $bash_out
  echo '' >> $bash_out
