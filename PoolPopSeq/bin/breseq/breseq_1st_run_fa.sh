...
mkdir -p /N/dc2/projects/muri2/Task2/PoolPopSeq/bin/breseq/breseq_1st_run_fa
mkdir -p "/N/dc2/projects/muri2/Task2/PoolPopSeq/bin/breseq/breseq_1st_run_fa/${DAY}"
mkdir -p /N/dc2/projects/muri2/Task2/PoolPopSeq/data/breseq_1st_run_fa
mkdir -p "/N/dc2/projects/muri2/Task2/PoolPopSeq/data/breseq_1st_run_fa/${DAY}"
...
do
  ...
  bash_out="/N/dc2/projects/muri2/Task2/PoolPopSeq/bin/breseq/breseq_1st_run_fa/${DAY}/${line}_breseq.sh"
  if [ -f $bash_out ]; then
    rm $bash_out
  fi
  ...
  OUT_gbk="/N/dc2/projects/muri2/Task2/PoolPopSeq/data/breseq_1st_run_fa/${DAY}/${line}"
  mkdir -p $OUT_gbk
  ...
  echo "breseq -j 8 -p -o ${OUT_gbk} -r ${REF_fna} ${reads}" >> $bash_out
  echo '' >> $bash_out
