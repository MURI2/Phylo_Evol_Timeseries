...
mkdir -p /N/dc2/projects/muri2/Task2/PoolPopSeq/data/pileup_fa
mkdir -p /N/dc2/projects/muri2/Task2/PoolPopSeq/data/timecourse_fa
...
do
  ...
  do
    ...
    do
      ...
      bams="/N/dc2/projects/muri2/Task2/PoolPopSeq/data/breseq_2nd_run_fa/D"*"/${pop}"*"/data/reference.bam"
      out="/N/dc2/projects/muri2/Task2/PoolPopSeq/data/pileup_fa/${pop}.pileup"
      ...
      cat ${out} | python /N/dc2/projects/muri2/Task2/PoolPopSeq/bin/samtools/create_timecourse_fa.py ${pop} > ${out_timecourse}
      rm ${out}
    done
  done
done
