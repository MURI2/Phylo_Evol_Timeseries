...
mkdir -p /N/dc2/projects/muri2/Task2/PoolPopSeq/data/pileup_fna
mkdir -p /N/dc2/projects/muri2/Task2/PoolPopSeq/data/timecourse_fna
...
do
  ...
  do
    ...
    do
      ...
      bams="/N/dc2/projects/muri2/Task2/PoolPopSeq/data/breseq_2nd_run_fna/D"*"/${pop}"*"/data/reference.bam"
      out="/N/dc2/projects/muri2/Task2/PoolPopSeq/data/pileup_fna/${pop}.pileup"
      samtools mpileup -q10 -f ${REF_fna} ${bams} > ${out}
      out_timecourse="/N/dc2/projects/muri2/Task2/PoolPopSeq/data/timecourse_fna/${pop}_timecourse.txt"
      cat ${out} | python /N/dc2/projects/muri2/Task2/PoolPopSeq/bin/samtools/create_timecourse.py ${pop} > ${out_timecourse}
      rm ${out}
    done
  done
done
